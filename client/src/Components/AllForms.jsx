        ...
        <>
            <div className='p-4'>
                <div className="mt-4 flex flex-wrap">
                    {data.map((item, index) => (
                        item.active ? <div className="bg-gradient-to-r from-blue-400 to-indigo-500 rounded-3xl p-4 text-center w-64 mx-2 my-2">
                            <div className="backdrop-blur-lg bg-opacity-50 bg-zinc-900 text-white py-4 px-5 text-center rounded-2xl shadow-lg max-w-xs mx-auto">
                                ...
                                <Link to={'/form/' + item._id} className="rounded-md bg-gradient-to-r from-blue-400 to-indigo-500 text-sm text-white py-2 px-4 inline">Fill Form</Link>
                            </div>
                        </div> : <></>
                    ))}
